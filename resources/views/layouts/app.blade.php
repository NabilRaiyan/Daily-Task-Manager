...
<body class="container mt-10 mb-10 mx-auto">
    <div>
        ...
        <div class="mt-5 mb-5 text-xl" x-data="{flash:true}">
            <!-- showing flash message -->
            @if (session()->has('success'))
                <div x-show="flash" class="relative bg-green-100 p-3 border border-green-600 text-green-800 rounded w-4/12 mx-auto" role="alert">
